...
/// <summary>
/// Utilities for XML document and files validation.
/// </summary>
public class XmlValidationUtilities
{
    /// <summary>
    /// Collection of the validation erros.
    /// </summary>
    private readonly ICollection<XmlValidationError> validationErrors = [];
    ...
    private bool LoadXmlSchemaSet(IEnumerable<Stream> schemasStreamCollection, out XmlSchemaSet xmlSchemaSet)
    {
        ...
        {
            validationErrors.Add(XmlValidationError.CreateNew(error));
        }
    ...
    private void XmlValidationCallback(object sender, ValidationEventArgs e)
    {
        ...
        if (e.Severity == XmlSeverityType.Error)
            validationErrors.Add(XmlValidationError.CreateNew(e.Exception));
    }
}
